...
/// </summary>
/// <remarks>
/// Subconjunto CURADO do conjunto Tabler (MIT, <c>Icons/LICENSE-tabler.txt</c>), copiado para
/// dentro do pacote — sem CDN e sem dependencia de runtime (ADR-005). Sao os icones que os 35
/// componentes da v1 precisam; a lista cresce sob demanda, e nao por completude.
/// </remarks>
